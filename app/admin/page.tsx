...
export default function AdminPage() {
  ...
  const toggleDossier = (id: string) => {
    setFormDossiers(prev => prev.includes(id) ? prev.filter(d => d !== id) : [...prev, id]);
  };
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#1a1f3a", display: "flex", flexDirection: "column" }}>
      ...
      {/* Zone blanche */}
      <div style={{
        background: "#f7f8fc", borderRadius: "0 0 0 80px",
        paddingTop: "60px", paddingLeft: "20px", paddingRight: "20px",
        paddingBottom: "24px", position: "relative", zIndex: 2,
      }}>
      ...
      {/* Zone bleu nuit */}
      <div style={{
        flex: 1, background: "#1a1f3a", borderRadius: "0 80px 0 0",
        marginTop: "-40px", paddingTop: "50px", paddingLeft: "20px",
        paddingRight: "20px", paddingBottom: "100px", position: "relative", zIndex: 1,
      }}>
        ...
        {tab === "users" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <div key={u.id} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                  <div style={{
                    ...
                    background: "rgba(255,77,90,0.2)", display: "flex",
                    alignItems: "center", justifyContent: "center",
                    fontSize: "18px", fontWeight: 800, color: "#ff4d5a", flexShrink: 0,
                  }}>
                  ...
                  <div style={{ display: "flex", gap: "6px" }}>
                    <button onClick={() => openEditForm(u)} style={{
                    ...
                    <button onClick={() => handleDeleteUser(u.id)} style={{
                      width: "34px", height: "34px", borderRadius: "11px",
                      background: "rgba(255,77,90,0.12)", border: "none",
                      cursor: "pointer", fontSize: "14px",
                    }}>🗑</button>
                  </div>
                </div>
            ...
            <button onClick={openCreateForm} style={{
              ...
              border: "2px dashed rgba(255,255,255,0.15)", background: "none",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {dossiers.map(d => (
              <div key={d.id} style={{
                ...
                <button onClick={() => handleDeleteDossier(d.id)} style={{
                  width: "34px", height: "34px", borderRadius: "11px",
                  background: "rgba(255,77,90,0.12)", border: "none",
                  cursor: "pointer", fontSize: "14px",
                }}>🗑</button>
            ...
            <div style={{
              ...
              <p style={{ fontSize: "13px", fontWeight: 700, color: "rgba(255,255,255,0.7)", marginBottom: "12px" }}>
                Nouveau dossier
              </p>
              <input
                type="text" placeholder="Nom du dossier (ex: Chez Marc)"
                value={newDossierNom} onChange={e => setNewDossierNom(e.target.value)}
                style={{ ...inputStyle, marginBottom: "10px" }}
              />
              <button onClick={handleCreateDossier} disabled={!newDossierNom || savingDossier} style={{
                width: "100%", padding: "14px", borderRadius: "14px",
                background: "linear-gradient(135deg, #ff4d5a, #ff6b35)",
                border: "none", color: "white", fontSize: "14px", fontWeight: 700,
                cursor: "pointer", fontFamily: "inherit",
                opacity: !newDossierNom ? 0.5 : 1,
                boxShadow: "0 8px 20px rgba(255,77,90,0.3)",
              }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  {dossiers.map(d => (
                    <button key={d.id} onClick={() => toggleDossier(d.id)} style={{
                      display: "flex", alignItems: "center", gap: "12px",
                      padding: "12px 14px", borderRadius: "14px", cursor: "pointer",
                      fontFamily: "inherit", fontSize: "14px", fontWeight: 600,
                      background: formDossiers.includes(d.id) ? "rgba(255,77,90,0.12)" : "rgba(255,255,255,0.05)",
                      border: `1px solid ${formDossiers.includes(d.id) ? "rgba(255,77,90,0.3)" : "rgba(255,255,255,0.07)"}`,
                      color: formDossiers.includes(d.id) ? "#ff4d5a" : "rgba(255,255,255,0.6)",
                      textAlign: "left",
                    }}>
                      <div style={{
                        width: "20px", height: "20px", borderRadius: "6px",
                        border: `2px solid ${formDossiers.includes(d.id) ? "#ff4d5a" : "rgba(255,255,255,0.2)"}`,
                        background: formDossiers.includes(d.id) ? "#ff4d5a" : "transparent",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "8px" }}>
                <button onClick={handleSaveUser} disabled={!formNom || formPin.length !== 4 || savingUser} style={{
                  width: "100%", padding: "16px", borderRadius: "16px",
                  background: "linear-gradient(135deg, #ff4d5a, #ff6b35)",
                  border: "none", color: "white", fontSize: "15px", fontWeight: 700,
                  cursor: "pointer", fontFamily: "inherit",
                  opacity: !formNom || formPin.length !== 4 ? 0.5 : 1,
                  boxShadow: "0 8px 20px rgba(255,77,90,0.3)",
                }}>
